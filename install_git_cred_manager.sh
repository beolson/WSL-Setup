...
if [[ "$ARCH" == "x86_64" ]]; then
    ...
    readonly GIT_CREDENTIAL_MANAGER_URL='https://github.com/beolson/git-credential-manager/releases/download/ARM/gcm-linux-arm64.2.6.0.deb';
    readonly GIT_CREDENTIAL_MANAGER_CHECKSUM='0bd5f5d1e1fdd142933ecf315b39acb90f116d52a9a82f81e2d9301cb75fbbd0  gcm.deb'
